...
CWS предоставя код на други езици за програмиране, като и други видове работни процеси.
Ето един пример с код на работен процес за латентно семантичен анализ (Latent Semantic Analysis) в програмния език R:
...
Според моя опит баристите на кодове и мениджърите на ИТ проекти предпочитат един начин за правене на нещата.
Също така, да не се излагат прекалено много на 
...
Което съвсем ни устройва, тъй като ние имаме решение, което добре служи на мало-акълните, когато са праволинейни.
...
Да перефразирам, предполагам, че 60÷80 % от вашите работни процеси по обработка на данни могат да бъдат обработени с това решение.
(Да, YMMV и принципът на Парето в комбинация.)

### [Позоваване към авторитети](https://en.wikipedia.org/wiki/Argument_from_authority)

Разбира се, добре е да обосновем подходът, като посочим как той съвпада с твърденията на определени авторитетни
фигури. Да речем, 
[Лари Уол](https://en.wikipedia.org/wiki/Larry_Wall) 
или 
[Лао Дзъ](https://en.wikipedia.org/wiki/Laozi).
