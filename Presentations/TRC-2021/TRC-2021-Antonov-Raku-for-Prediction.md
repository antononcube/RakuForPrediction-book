...
(*"/Users/antonov/MathFiles/Presentations/TRC-2021"*)
```
...
(*{"ImagesExportURL" -> Automatic, "ImagesFetchURL" -> "Relative", "ImageNameFunction" -> Automatic, "OverwriteImages" -> True, "IgnoredStyles" -> None, "CellStyleRules" -> Automatic, "CodeLanguage" -> "mathematica", "BoxesToStringType" -> "InputText", "MDElementTemplates" -> Automatic}*)
```

```mathematica
fileName = StringReplace[FileNameSplit[NotebookFileName[]][[-1]], {".nb" ~~ EndOfString -> ".md"}]

(*"TRC-2021-Antonov-Raku-for-Prediction.md"*)
```
...
![0jvphr5afm0r9](./Diagrams/0jvphr5afm0r9.png)
