...
за много програмни други езици: Julia, Python, R, Raku, Wolfram Language.
...
Аз реализирах такава уеб услуга чрез съзвездието от Raku библиотеките Cro; 
...
- Имплементация на функционалности за събиране и генериране на данни чрез разговарен агент.

    - Реализирах такиви агенти в Raku и WL, [AAv5].
...
**Забележка:** Цитатът, перифразиран по-горе,
[и се приписва се на Уилям Гибсън](https://quoteinvestigator.com/2012/01/24/future-has-arrived/)
е:
