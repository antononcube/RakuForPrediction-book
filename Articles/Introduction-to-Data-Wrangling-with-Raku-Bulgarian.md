...
аз програмирах (в края 2021) пакети за обработка на данни на езика Raku.
...
За да можем да обсъждаме и да дадем примери за работа с данни, трябва да използваме определени функционалности за добиване на данни.
