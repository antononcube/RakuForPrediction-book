...
**Забележка:** R беше (и вероятно все още е) доста загадъчен език за програмиране, така че изричното въвеждане на модела
Разделяне-Трансформиране-Комбиниране е от голяма полза за програмистите на R. От друга страна, този модел е доста стар
...
Представяме един прост сценарий за проиграване по тази блок схема.
...
фигури. Да речем, 
[Лари Уол](https://bg.wikipedia.org/wiki/Larry_Wall) 
или 
[Лао Дзъ](https://bg.wikipedia.org/wiki/Лао_Дзъ).

### Лари Уол

В интервюто на Лари Уол, поместено в книгата "Masterminds of programming", [FB1], Лари Уол описва Perl 6 (Raku) като:
...
Ето някои от моите предстоящи планове за събиране и обработка на данни с помощта на Raku,
...
Както беше споменато във въведението, тази статия е преод от английски език.
...
- Буквалните преводи на поговорката "Децата на обущаря боси ходят" съществуват като поговорки w немския и английския.
...
- Името на тази секция се позовава към играта "Развален телефон" и
